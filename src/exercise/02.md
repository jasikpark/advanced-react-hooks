...
I learned a lot about useCallback and useMemoize and that useLayout is saying
"run this effect w/o waiting for layout changes to resolve"

AbortController is fun though it sounds like that would be something at the user
level when you're constructing the fetch
